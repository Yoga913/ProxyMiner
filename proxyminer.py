...
def print_welcome():
    ...
    print("\033[1m\033[92mSelamat datang di \033[1m\033[95mLuminaProxy\033[0m - \033[1m\033[96mPengambil Proxy Terang Anda\033[0m\n")
    print("\033[1m👨‍💻 Pengembang:\033[0m AnonCatalyst\n\033[1m🔗 GitHub:\033[0m [AnonCatalyst di GitHub](https://github.com/AnonCatalyst)")
